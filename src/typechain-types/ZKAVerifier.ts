...
export interface ZKAVerifierInterface extends Interface {
  getFunction(
    nameOrSignature: "ZKAFactory" | "ZKVerifier" | "initializer" | "zkpVerify"
  ): FunctionFragment;
...
export interface ZKAVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): ZKAVerifier;
  waitForDeployment(): Promise<this>;

  interface: ZKAVerifierInterface;
